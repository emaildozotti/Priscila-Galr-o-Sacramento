# LP -- Priscila Galrao Sacramento

Repositorio standalone da landing page de Priscila Galrao Sacramento.
...
- **Cliente:** Priscila Galrao Sacramento
- **GitHub:** https://github.com/emaildozotti/Priscila-Galr-o-Sacramento
- **Vercel:** https://priscila-galrao.vercel.app
...
```bash
git commit -m "feat: foto e video inseridos -- Priscila Galrao Sacramento ao ar"
...
- O remote `origin` = `emaildozotti/Priscila-Galr-o-Sacramento` -- nao alterar
